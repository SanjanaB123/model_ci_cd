...
# except ImportError as e:
#     raise ImportError("Install mlflow: pip install mlflow") from e
...
#     with mlflow.start_run(run_name="lstm_supply_chain") as run:
#         # Log model
#         mlflow.pytorch.log_model(
#             model,
#             artifact_path="model",
#             registered_model_name="lstm-supply-chain"
#         )
...
#         mlflow.log_artifact(str(curve_path), "training_curve")
#         mlflow.log_artifact(str(report_path), "reports")
        
#         log.info("LSTM model and artifacts logged to MLflow run: %s", run.info.run_id)
